...
WEBHOOK_URL = os.environ.get('WEBHOOK_URL', "https://havolalardfbot.onrender.com/webhook")  # Masalan: 'https://your-app-name.herokuapp.com/webhook' – deployment da o'rnating
